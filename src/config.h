...
#define PACKAGE_STRING "dreamchess 0.2.1-RC2"
...
#define PACKAGE_VERSION "0.2.1-RC2"
...
/* Define to 1 to enable music and sound effects through SDL_mixer. */
#define WITH_MIXER_SDL 1
